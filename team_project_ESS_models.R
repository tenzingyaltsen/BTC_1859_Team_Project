...
# AIC and anova showed that the simpler model is better. Let's keep going. Remove
# Any.fibro as a variable from the model.
ess_glm_mod_back_3 <- glm(ESS ~ Corticoid + Depression + Liver.diag + 
                            RGD + Gender, 
                          data = clean_data_ess_model, family = "binomial")
...
# The simpler model is better. One of the levels of Liver.diag had the highest
# p-value but the other levels had lower p-values. Gender is the variable with
# the next highest p-value. Let's remove that. 
