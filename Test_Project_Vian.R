...
#' to PSQIS. Whereas, there are 85 participants who do not experience 
#' sleep disturbance.
table(clean_data2$PSQIS)
#' Restricting the number of predictors by following the rule of thumb of 
#' p < m/10.
85 / 10
# 8 predictors/degrees of freedom that can be used in the PSQIS model.
